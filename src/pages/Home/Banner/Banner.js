        ...
        <div className="hero lg:min-h-screen bg-sky-950 ">
            <div className="hero-content flex-col lg:flex-row-reverse lg:gap-20">
                ...
                <div className='w-1/2 text-sky-100'>
                    ...
                    <p className='lg:text-lg font-medium mb-12 tracking-wide text-justify'>Learning <span className='text-amber-500'>Back-End Web Development</span> passionate about creating interactive applications and experiences on the web.I'm always up for a challenge and driven to exceed expectations.</p>
                    ...
                    <button className="btn btn-warning text-sky-100 font-semibold bg-amber-500 rounded px-12 mb-4 mr-5 ">Get In Touch</button>
                    <button className="btn btn-outline rounded btn-warning px-8">Download Resume</button>
                </div>
            </div>
        </div>
    );
