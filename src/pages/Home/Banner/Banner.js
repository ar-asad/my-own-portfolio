        ...
        <div className="hero lg:min-h-screen lg:pt-12 pt-20 lg:w-full">
            <div className="hero-content flex-col lg:flex-row-reverse lg:gap-20  ">
                ...
                <div className='lg:w-1/2 w-4/5 text-sky-100'>
                    ...
                    <p id='sub-title' className='text-2xl font-semibold text-slate-400 mb-4'>Web Developer</p>
                    ...
                    <button className="btn btn-warning text-sky-100 font-semibold bg-amber-500 rounded lg:px-12 px-9 mb-4 mr-5 ">Get In Touch</button>
                    <button className="btn btn-outline rounded btn-warning lg:px-8 ">Download Resume</button>
                </div>
            </div>
        </div>
    );
