...
const HomeProject = () => {
    ...
    return (
        <div id='project' className='lg:w-10/12 lg:mx-auto mt-12 lg:px-0 px-8'>
            <div className=' text-start text-sky-100 mb-10'>
                <p className='lg:mb-2 sub-title'>take a look my</p>
                <h1 className="text-2xl lg:text-3xl font-semibold mb-3">PROJECTS</h1>
            </div>
            <div>
