...
const HomeSkill = () => {
    return (
        <div className='lg:w-10/12 lg:mx-auto text-sky-100 lg:px-0 px-6 lg:py-10 lg:pt-20'>
            <div className=' text-start text-sky-100 mb-8'>
                <p data-aos="fade-left" className='lg:mb-2 sub-title'>check out</p>
                <h1 data-aos="fade-right" className="text-2xl lg:text-3xl font-semibold mb-3">TECHNICAL SKILL</h1>
            </div>
            <div data-aos="flip-right"
                ...
                <div className='grid lg:grid-cols-6 grid-cols-4 gap-3 bg-white text-black lg:p-12 p-6 shadow-xl shadow-amber-600 rounded'>
                    <div data-aos="flip-right"
                        ...
                        data-aos-duration="2000" className='flex justify-center flex-col items-center'>
